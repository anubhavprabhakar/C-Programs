/*Developed by: Anubhav Prabhakar
Version: 2.1.4
Calender: input year and month, then change to next or previous months or years*/
#include<stdio.h>
#include<conio.h>
#include<stdlib.h>
#include<windows.h>
...
int main()
{
    ...
    while(i==0)
    {
        ...
        switch (ch)
        {
            ...
            case 27://esc key
                system("CLS");
                printf("Thank you for using calender version 2.1.2\nPress any key to exit");
                getch();
...
void cal(int d, int m, int y, int p)
{
    ...
    //dispaly info
    gotoxy(6, 0);
    printf("Calendar version 2.1.4   Made by Anubhav Prabhakar");
...
//function to help print the calender design
void gotoxy(short int col, short int row)
{
...
int getkey()
{
    ...
    if(ch==224||0)//if enter key is pressed
    {
        ch=getch();
    }
    return ch;
